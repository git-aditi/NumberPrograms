package com.company.java.petersonNumber;
...
public class PetersonNumberExample1 {
	...
	//an array is defined to quickly find the factorial
	...
	//function to check if the given number is Peterson or not
	static boolean isPeterson(int n) {
		...
		while(n>0) {
			...
			//determines the factorial of the digit and adds it to the variable sum
			sum += factorial[digit];
